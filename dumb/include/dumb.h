...
DUH *DUMBEXPORT dumb_load_mod(const char *filename, int is_restrict);
...
DUH *DUMBEXPORT dumb_read_mod(DUMBFILE *f, int is_restrict);
...
DUH *DUMBEXPORT dumb_load_mod_quick(const char *filename, int is_restrict);
...
DUH *DUMBEXPORT dumb_read_mod_quick(DUMBFILE *f, int is_restrict);
